...
**Public Property Risk** is calculated in risk units using the standard approach for all Risk Matrix Value Measures:
...
> Public Property Risk = Baseline Risk - Outcome Risk