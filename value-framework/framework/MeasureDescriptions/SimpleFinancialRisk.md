...
**Simple Financial Risk** is calculated in risk units using the standard approach for all Risk Matrix Value Measures:
...
> Simple Financial Risk = Baseline Risk - Outcome Risk