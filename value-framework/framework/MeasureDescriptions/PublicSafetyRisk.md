...
**Public Safety Risk** is calculated in risk units using the standard approach for all Risk Matrix Value Measures:
...
> Public Safety Risk = Baseline Risk - Outcome Risk