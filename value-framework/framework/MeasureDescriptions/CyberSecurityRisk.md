...
**Cyber Security Risk** is calculated in risk units using the standard approach for all Risk Matrix Value Measures:
...
> Cyber Security Risk = Baseline Risk - Outcome Risk