...
using baseClass = MeasureFormulas.Generated_Formula_Base_Classes.ResourceForecastProjectManagerBase;
using formulaClass = CustomerFormulaCode.ResourceForecastProjectManager;

namespace MeasureFormula.Tests
{
    public class ResourceForecastProjectManagerTest : MeasureFormulaTestsBase
    {
        ...
        public void FixtureSetup()
        {
            ...
            ResourceSupplySpend.ResourceCode = CoreConstants.PROJ_MGR;
        ...
        private DistributionByResourceDTO CreatingOutOfRangeResourceSpendSuppleDto()
        {
            ...
            spendValueOutOfRangeDto.ResourceCode = CoreConstants.PROJ_MGR;
            
            var outOfRangeResourceSpendSupplyDto = new DistributionByResourceDTO();
            outOfRangeResourceSpendSupplyDto.ResourceValues.Add(spendValueOutOfRangeDto);
            return outOfRangeResourceSpendSupplyDto;
        }
        ...
        {
            var demoResourceSupplyDto = CreatingOutOfRangeResourceSpendSuppleDto();
