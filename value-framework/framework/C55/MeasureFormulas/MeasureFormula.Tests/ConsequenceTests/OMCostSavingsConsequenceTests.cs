...
using baseClass = MeasureFormulas.Generated_Formula_Base_Classes.OMCostSavingsConsequenceBase;
using formulaClass = CustomerFormulaCode.OMCostSavingsConsequence;
 
namespace MeasureFormula.Tests
{
    [TestFixture]
    public class OMCostSavingsConsequenceTests : MeasureFormulaTestsBase
    {      
        ...
        private const int AnnualOMAdditionalValue = 50000;
        ...
        public void FixtureSetup()     
        {
            ...
            DataPrep.SetConstructorParameter(fixture, "p_AnnualOMAdd", AnnualOMAdditionalValue);
        ...
        public void GetUnits_WhenPassedInValidInputs_ComputesCorrectly()
        {
            ...
            var expectedOutput = Enumerable.Repeat((double?)(AnnualOMValue - AnnualOMAdditionalValue), ArbitraryMonths).ToArray();
