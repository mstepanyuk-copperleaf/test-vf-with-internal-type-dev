...
using baseClass = MeasureFormulas.Generated_Formula_Base_Classes.CapitalCostAvoidanceConsequenceBase;
using formulaClass = CustomerFormulaCode.CapitalCostAvoidanceConsequence;
 
namespace MeasureFormula.Tests
{
    [TestFixture]
    public class CapitalCostAvoidanceConsequenceTests : MeasureFormulaTestsBase
    {      
        ...
        public void GetUnits_WhenPassedInValidInputs_ComputesCorrectly()
        {
            ...
            var expectedOutput = Enumerable.Repeat((double?)AnnualCapitalValue, ArbitraryMonths).ToArray();
