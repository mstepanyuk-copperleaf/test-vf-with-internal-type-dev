...
using baseClass = MeasureFormulas.Generated_Formula_Base_Classes.RevenueIncreaseConsequenceBase;
using formulaClass = CustomerFormulaCode.RevenueIncreaseConsequence;
 
namespace MeasureFormula.Tests
{
    [TestFixture]
    public class RevenueIncreaseConsequenceTests : MeasureFormulaTestsBase
    {      
