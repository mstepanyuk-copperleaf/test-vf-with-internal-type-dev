...
using baseClass = MeasureFormulas.Generated_Formula_Base_Classes.SimpleAssetFinancialProbabilityOutcomeBase;
using formulaClass = CustomerFormulaCode.SimpleAssetFinancialProbabilityOutcome;

namespace MeasureFormula.Tests
{
    public class SimpleAssetFinancialProbabilityOutcomeTest : MeasureFormulaTestsBase
    {
        ...
        private void InitializeTimeInvariantTestData(
            double? financeRiskExposureFactor,
