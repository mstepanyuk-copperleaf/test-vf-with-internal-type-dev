...
using baseClass = MeasureFormulas.Generated_Formula_Base_Classes.SimpleAssetEnvironmentalProbabilityBaselineBase;
using formulaClass = CustomerFormulaCode.SimpleAssetEnvironmentalProbabilityBaseline;

namespace MeasureFormula.Tests
{
    public class SimpleAssetEnvironmentalProbabilityBaselineTest : MeasureFormulaTestsBase
    {
        ...
        public void FixtureSetup()
        {
         ...
         private void InitializeTimeInvariantTestData(
             double? riskExposureFactor,
             double?[] conditionScore,
             XYCurveDTO conditionToFailureCurve)
        {
            DataPrep.SetConstructorParameter(fixture, "p_AssetTypeEnvironmentalRiskExposureFactor", riskExposureFactor);
