...
using baseClass = MeasureFormulas.Generated_Formula_Base_Classes.SimpleAssetEnvironmentalProbabilityOutcomeBase;
using formulaClass = CustomerFormulaCode.SimpleAssetEnvironmentalProbabilityOutcome;

namespace MeasureFormula.Tests
{
    public class SimpleAssetEnvironmentalProbabilityOutcomeTest : MeasureFormulaTestsBase
    {
