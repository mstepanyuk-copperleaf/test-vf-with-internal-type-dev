...
{
    [FormulaBase]
    public abstract class VVOEnergySavingsConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double?[] p_EnergyEfficiency_EnergySavingsTotal_ConsqUnitOutput,
                System.Boolean p_VVO)
            {
                EnergyEfficiency_EnergySavingsTotal_ConsqUnitOutput = p_EnergyEfficiency_EnergySavingsTotal_ConsqUnitOutput;
                VVO = p_VVO;
            }
            
            [MeasureInput("EnergyEfficiency", "EnergySavingsTotal", MeasureOutputType.ConsqUnitOutput, false)]
            [DataMember]
            public System.Double?[] EnergyEfficiency_EnergySavingsTotal_ConsqUnitOutput  { get; private set; }
            
            [PromptInput("VVO")]
            [DataMember]
            public System.Boolean VVO  { get; private set; }
        }
