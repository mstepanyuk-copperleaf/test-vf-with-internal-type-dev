...
{
    [FormulaBase]
    public abstract class RenewableCapacityKPIConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double p_RenewableCapacityAdded,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                RenewableCapacityAdded = p_RenewableCapacityAdded;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("RenewableCapacityAdded")]
            [DataMember]
            public System.Double RenewableCapacityAdded  { get; private set; }
