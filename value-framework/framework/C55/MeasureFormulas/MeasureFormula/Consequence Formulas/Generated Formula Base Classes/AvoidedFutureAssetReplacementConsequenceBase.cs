...
{
    [FormulaBase]
    public abstract class AvoidedFutureAssetReplacementConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                ...
                System.Double? p_SystemReactiveReplacementCostFactor)
            {
                ...
                SystemReactiveReplacementCostFactor = p_SystemReactiveReplacementCostFactor;
            }
            ...
            [CustomFieldInput("ReactiveReplacementCostFactor", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public System.Double? SystemReactiveReplacementCostFactor  { get; private set; }
        }
