...
{
    [FormulaBase]
    public abstract class SimpleAssetLGRConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Boolean? p_AssetContributesToLostGeneration,
            ...
            {
                AssetContributesToLostGeneration = p_AssetContributesToLostGeneration;
            ...
            [CustomFieldInput("ContributesToLostGeneration", FormulaInputAssociatedEntity.Asset)]
            [DataMember]
            public System.Boolean? AssetContributesToLostGeneration  { get; private set; }
