...
{
    [FormulaBase]
    public abstract class CostSavingsTotalConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int64 p_CostsSaved,
                System.Double p_HoursSaved,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                CostsSaved = p_CostsSaved;
                HoursSaved = p_HoursSaved;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("CostsSaved")]
            [DataMember]
            public System.Int64 CostsSaved  { get; private set; }
            
            [PromptInput("HoursSaved")]
            [DataMember]
            public System.Double HoursSaved  { get; private set; }
