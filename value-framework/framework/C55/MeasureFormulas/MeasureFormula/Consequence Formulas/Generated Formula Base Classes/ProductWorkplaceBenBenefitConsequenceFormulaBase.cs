...
{
    [FormulaBase]
    public abstract class ProductWorkplaceBenBenefitConsequenceFormulaBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double p_NoEmployeesAffected,
                System.Double p_NoEmployeesAtRiskOfLeaving,
            ...
            {
                NoEmployeesAffected = p_NoEmployeesAffected;
                NoEmployeesAtRiskOfLeaving = p_NoEmployeesAtRiskOfLeaving;
                TimePeriod = p_TimePeriod;
                WorkplaceImpactOnProductivity = p_WorkplaceImpactOnProductivity;
            }
            
            [PromptInput("NoEmployeesAffected")]
            [DataMember]
            public System.Double NoEmployeesAffected  { get; private set; }
            
            [PromptInput("NoEmployeesAtRiskOfLeaving")]
            [DataMember]
            public System.Double NoEmployeesAtRiskOfLeaving  { get; private set; }
