...
{
    [FormulaBase]
    public abstract class CMTotalMilesCostBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double?[] p_Mileage_TotalMileageCompany_LikelihoodUnitOutput,
                System.Double? p_SystemCompanyMileageCostPoundsPerMile)
            {
                Mileage_TotalMileageCompany_LikelihoodUnitOutput = p_Mileage_TotalMileageCompany_LikelihoodUnitOutput;
                SystemCompanyMileageCostPoundsPerMile = p_SystemCompanyMileageCostPoundsPerMile;
            }
            
            [MeasureInput("Mileage", "TotalMileageCompany", MeasureOutputType.LikelihoodUnitOutput, false)]
            [DataMember]
            public System.Double?[] Mileage_TotalMileageCompany_LikelihoodUnitOutput  { get; private set; }
            
            [CustomFieldInput("CompanyMileageCostPoundsPerMile", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public System.Double? SystemCompanyMileageCostPoundsPerMile  { get; private set; }
        }
