...
{
    [FormulaBase]
    public abstract class ComplianceConsequenceOutcomeBase : FormulaConsequenceBase
    {
        [DataContract]
...
// TODO                System.Double p_PenaltyAmountPounds
 )
            {
                InvestmentSpendByAccountType = p_InvestmentSpendByAccountType;
    //            PenaltyAmountPounds = p_PenaltyAmountPounds;
            }
    ...
    //        [PromptInput("PenaltyAmount")]
    //        [DataMember]
    //        public System.Double PenaltyAmountPounds  { get; private set; }
        }
