...
{
    [FormulaBase]
    public abstract class OMCostAvoidanceConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            ...
            [PromptInput("AnnualOM")]
            [DataMember]
            public System.Int32 AnnualOM  { get; private set; }
