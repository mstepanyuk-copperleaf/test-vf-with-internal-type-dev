...
{
    [FormulaBase]
    public abstract class HSRiskOtherTotalBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
// TODO                System.Double?[] p_HealthAndSafety_HealthAndSafetyRiskOtherInjuries_ConsqUnitOutput
)
            {
//                HealthAndSafety_HealthAndSafetyRiskOtherInjuries_ConsqUnitOutput = p_HealthAndSafety_HealthAndSafetyRiskOtherInjuries_ConsqUnitOutput;
            }
            
//            [MeasureInput("HealthAndSafetyQuestionnaire", "HealthAndSafetyRiskOtherInjuries", MeasureOutputType.ConsqUnitOutput, false)]
//            [DataMember]
//            public System.Double?[] HealthAndSafety_HealthAndSafetyRiskOtherInjuries_ConsqUnitOutput  { get; private set; }
        }
