...
{
    [FormulaBase]
    public abstract class SimpleAssetEnvironmentalConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                CL.FormulaHelper.DTOs.NumericValueRangeDTO p_AssetEnvironmentalRiskConsequence,
                CL.FormulaHelper.DTOs.NumericValueRangeDTO p_FailureSeverity)
            {
                AssetEnvironmentalRiskConsequence = p_AssetEnvironmentalRiskConsequence;
                FailureSeverity = p_FailureSeverity;
            }
            
            [CustomFieldInput("EnvironmentalRiskConsequence", FormulaInputAssociatedEntity.Asset)]
            [DataMember]
            public CL.FormulaHelper.DTOs.NumericValueRangeDTO AssetEnvironmentalRiskConsequence  { get; private set; }
            
            [CoreFieldInput(FormulaCoreFieldInputType.FailureSeverity)]
            [DataMember]
            public CL.FormulaHelper.DTOs.NumericValueRangeDTO FailureSeverity  { get; private set; }
        }
