...
{
    [FormulaBase]
    public abstract class HSOtherInjuryRiskBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
//                System.Double?[] p_HealthAndSafety_NumberOfOtherInjuries_LikelihoodUnitOutput,
                System.Double? p_SystemOtherInjuryCost)
            {
// TODO                HealthAndSafety_NumberOfOtherInjuries_LikelihoodUnitOutput = p_HealthAndSafety_NumberOfOtherInjuries_LikelihoodUnitOutput;
                SystemOtherInjuryCost = p_SystemOtherInjuryCost;
            }
            
//            [MeasureInput("HealthAndSafetyQuestionnaire", "NumberOfOtherInjuries", MeasureOutputType.LikelihoodUnitOutput, false)]
//            [DataMember]
//            public System.Double?[] HealthAndSafety_NumberOfOtherInjuries_LikelihoodUnitOutput  { get; private set; }
            
            [CustomFieldInput("OtherInjuryCost", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public System.Double? SystemOtherInjuryCost  { get; private set; }
        }
