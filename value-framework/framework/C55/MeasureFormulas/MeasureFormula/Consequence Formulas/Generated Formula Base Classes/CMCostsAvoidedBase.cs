...
{
    [FormulaBase]
    public abstract class CMCostsAvoidedBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
// TODO: fix                System.Double?[] p_Mileage_CostOfTotalMileageCompanyPounds_ConsqUnitOutput,
 //               System.Double?[] p_Mileage_CostOfTotalMileageCompanyPounds_ConsqUnitOutput_B
  )
            {
    //            Mileage_CostOfTotalMileageCompanyPounds_ConsqUnitOutput = p_Mileage_CostOfTotalMileageCompanyPounds_ConsqUnitOutput;
      //          Mileage_CostOfTotalMileageCompanyPounds_ConsqUnitOutput_B = p_Mileage_CostOfTotalMileageCompanyPounds_ConsqUnitOutput_B;
            }
     
            /*
            [MeasureInput("Mileage", "CostOfTotalMileageCompany", MeasureOutputType.ConsqUnitOutput, false)]
            [DataMember]
            public System.Double?[] Mileage_CostOfTotalMileageCompanyPounds_ConsqUnitOutput  { get; private set; }
            
            [MeasureInput("Mileage", "CostOfTotalMileageCompany", MeasureOutputType.ConsqUnitOutput, true)]
            [DataMember]
            public System.Double?[] Mileage_CostOfTotalMileageCompanyPounds_ConsqUnitOutput_B  { get; private set; }
*/
        }
