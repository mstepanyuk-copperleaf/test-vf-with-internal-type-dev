...
{
    [FormulaBase]
    public abstract class HSRiskCarTotalBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
// TODO                System.Double?[] p_HealthAndSafety_HealthAndSafetyRiskCarAccidents_ConsqUnitOutput
 )
            {
    //            HealthAndSafety_HealthAndSafetyRiskCarAccidents_ConsqUnitOutput = p_HealthAndSafety_HealthAndSafetyRiskCarAccidents_ConsqUnitOutput;
            }
            
   //         [MeasureInput("HealthAndSafetyQuestionnaire", "HealthAndSafetyRiskCarAccidents", MeasureOutputType.ConsqUnitOutput, false)]
   //         [DataMember]
   //         public System.Double?[] HealthAndSafety_HealthAndSafetyRiskCarAccidents_ConsqUnitOutput  { get; private set; }
        }
