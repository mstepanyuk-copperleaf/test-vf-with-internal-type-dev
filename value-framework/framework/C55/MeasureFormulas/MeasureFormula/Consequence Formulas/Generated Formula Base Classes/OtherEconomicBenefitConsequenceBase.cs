...
{
    [FormulaBase]
    public abstract class OtherEconomicBenefitConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_OtherEconomicBenefitAmount,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                OtherEconomicBenefitAmount = p_OtherEconomicBenefitAmount;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("OtherEconomicBenefitAmount")]
            [DataMember]
            public System.Int32 OtherEconomicBenefitAmount  { get; private set; }
