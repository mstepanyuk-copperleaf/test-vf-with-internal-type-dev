...
{
    [FormulaBase]
    public abstract class ResValAssetAgeBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.DateTime p_AlternativeStartDate,
                System.DateTime? p_AssetEffectiveAge)
            {
                AlternativeStartDate = p_AlternativeStartDate;
                AssetEffectiveAge = p_AssetEffectiveAge;
            }
            
            [CoreFieldInput(FormulaCoreFieldInputType.AlternativeStartDate)]
            [DataMember]
            public System.DateTime AlternativeStartDate  { get; private set; }
            
            [PromptInput("AssetEffectiveAge")]
            [DataMember]
            public System.DateTime? AssetEffectiveAge  { get; private set; }
        }
