...
{
    [FormulaBase]
    public abstract class ConditionOutcomeConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                ...
                System.Boolean p_AssetImpactedByAlternative,
                System.DateTime? p_AssetInServiceDate)
            {
                AssetConditionDecayCurve = p_AssetConditionDecayCurve;
                AssetImpactedByAlternative = p_AssetImpactedByAlternative;
            ...
            [PromptInput("AssetImpactedByAlternative")]
            [DataMember]
            public System.Boolean AssetImpactedByAlternative  { get; private set; }
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double p_OutcomeConditionScore,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                OutcomeConditionScore = p_OutcomeConditionScore;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("OutcomeConditionScore")]
            [DataMember]
            public System.Double OutcomeConditionScore  { get; private set; }
