...
{
    [FormulaBase]
    public abstract class SimpleAssetReactiveReplacementCostConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                ...
                System.Double? p_AssetTypeExtraDamageFactor)
            {
                AssetReplacementCost = p_AssetReplacementCost;
                AssetTypeExtraDamageFactor = p_AssetTypeExtraDamageFactor;
            }
            ...
            [CoreFieldInput(FormulaCoreFieldInputType.AssetTypeExtraDamageFactor)]
            [DataMember]
            public System.Double? AssetTypeExtraDamageFactor  { get; private set; }
        }
