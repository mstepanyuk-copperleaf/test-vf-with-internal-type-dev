...
{
    [FormulaBase]
    public abstract class PMCarbonRiskBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double?[] p_Mileage_CarbonSavingsPrivateTonnesC02e_ConsqUnitOutput,
                CL.FormulaHelper.DTOs.TimeSeriesDTO p_SystemNonTradedPriceOfCarbonPerTonnesC02e)
            {
                Mileage_CarbonSavingsPrivateTonnesC02e_ConsqUnitOutput = p_Mileage_CarbonSavingsPrivateTonnesC02e_ConsqUnitOutput;
                SystemNonTradedPriceOfCarbonPerTonnesC02e = p_SystemNonTradedPriceOfCarbonPerTonnesC02e;
            }
            
            [MeasureInput("Mileage", "CarbonSavingsPrivateTonnesC02e", MeasureOutputType.ConsqUnitOutput, false)]
            [DataMember]
            public System.Double?[] Mileage_CarbonSavingsPrivateTonnesC02e_ConsqUnitOutput  { get; private set; }
            
            [CustomFieldInput("NonTradedPriceOfCarbonPerTonnesC02e", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public CL.FormulaHelper.DTOs.TimeSeriesDTO SystemNonTradedPriceOfCarbonPerTonnesC02e  { get; private set; }
        }
