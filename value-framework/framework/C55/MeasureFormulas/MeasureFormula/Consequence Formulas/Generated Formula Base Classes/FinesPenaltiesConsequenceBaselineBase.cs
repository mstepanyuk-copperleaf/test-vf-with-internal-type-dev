...
{
    [FormulaBase]
    public abstract class FinesPenaltiesConsequenceBaselineBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            ...
            [PromptInput("FineAmount")]
            [DataMember]
            public System.Double FineAmount  { get; private set; }
