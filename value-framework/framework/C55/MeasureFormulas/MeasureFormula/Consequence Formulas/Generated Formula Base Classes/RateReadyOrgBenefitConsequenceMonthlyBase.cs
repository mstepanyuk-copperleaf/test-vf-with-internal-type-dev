...
{
    [FormulaBase]
    public abstract class RateReadyOrgBenefitConsequenceMonthlyBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                CL.FormulaHelper.DTOs.CustomFieldListItemDTO p_RRO1,
            ...
            [PromptInput("RRO1")]
            [DataMember]
            public CL.FormulaHelper.DTOs.CustomFieldListItemDTO RRO1  { get; private set; }
