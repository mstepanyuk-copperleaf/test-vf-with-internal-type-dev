...
{
    [FormulaBase]
    public abstract class CMCarbonTBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                ...
                System.Double? p_SystemCarbonConversionFactorPerMile)
            {
                Mileage_TotalMileageCompany_LikelihoodUnitOutput = p_Mileage_TotalMileageCompany_LikelihoodUnitOutput;
                SystemCarbonConversionFactorPerMile = p_SystemCarbonConversionFactorPerMile;
            }
            ...
            [CustomFieldInput("CarbonConversionFactorPerMile", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public System.Double? SystemCarbonConversionFactorPerMile  { get; private set; }
        }
