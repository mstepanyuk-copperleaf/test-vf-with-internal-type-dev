    ...
    public abstract class EnvironmentalBenefitConsequenceBase : FormulaConsequenceBase
    {
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_CO2Reduction,
                System.Int32 p_EnergySavings,
                System.Double p_SF6Reduction,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                CO2Reduction = p_CO2Reduction;
                EnergySavings = p_EnergySavings;
                SF6Reduction = p_SF6Reduction;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("CO2Reduction")]
            [DataMember]
            public System.Int32 CO2Reduction  { get; private set; }
            
            [PromptInput("EnergySavings")]
            [DataMember]
            public System.Int32 EnergySavings  { get; private set; }
            
            [PromptInput("SF6Reduction")]
            [DataMember]
            public System.Double SF6Reduction  { get; private set; }
