...
{
    [FormulaBase]
    public abstract class HSCarAccidentRiskBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
//                System.Double?[] p_HealthAndSafety_NumberOfCarAccidents_LikelihoodUnitOutput,
                System.Double? p_SystemCarAccidentCost)
            {
//                HealthAndSafety_NumberOfCarAccidents_LikelihoodUnitOutput = p_HealthAndSafety_NumberOfCarAccidents_LikelihoodUnitOutput;
                SystemCarAccidentCost = p_SystemCarAccidentCost;
            }
            
//            [MeasureInput("HealthAndSafetyQuestionnaire", "NumberOfCarAccidents", MeasureOutputType.LikelihoodUnitOutput, false)]
//            [DataMember]
//            public System.Double?[] HealthAndSafety_NumberOfCarAccidents_LikelihoodUnitOutput  { get; private set; }
            
            [CustomFieldInput("CarAccidentCost", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public System.Double? SystemCarAccidentCost  { get; private set; }
        }
