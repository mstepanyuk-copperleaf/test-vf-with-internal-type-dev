...
{
    [FormulaBase]
    public abstract class CustomerServiceBenConsequenceFormulaBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                CL.FormulaHelper.DTOs.CustomFieldListItemDTO p_CustomerSatisfactionImprovement,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                CustomerSatisfactionImprovement = p_CustomerSatisfactionImprovement;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("CustomerSatisfactionImprovement")]
            [DataMember]
            public CL.FormulaHelper.DTOs.CustomFieldListItemDTO CustomerSatisfactionImprovement  { get; private set; }
