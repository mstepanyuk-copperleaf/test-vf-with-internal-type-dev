...
{
    [FormulaBase]
    public abstract class EnergyEfficiencyConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double? p_SystemCO2perMWh,
                System.Double? p_SystemEnergySavingsValueDollarsPerMWh,
                System.Double? p_SystemGHGValue)
            {
                SystemCO2perMWh = p_SystemCO2perMWh;
                SystemEnergySavingsValueDollarsPerMWh = p_SystemEnergySavingsValueDollarsPerMWh;
                SystemGHGValue = p_SystemGHGValue;
            }
            
            [CustomFieldInput("CO2perMWh", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public System.Double? SystemCO2perMWh  { get; private set; }
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_PowerSavings,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                PowerSavings = p_PowerSavings;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("PowerSavings")]
            [DataMember]
            public System.Int32 PowerSavings  { get; private set; }
