    ...
    public abstract class EmissionLevelsConsequenceBase : FormulaConsequenceBase
    {
        ...
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                CL.FormulaHelper.DTOs.TimeSeriesDTO p_SystemCO2CreditsValueDollarsPerMWhTimeSeries)
            {
                SystemCO2CreditsValueDollarsPerMWhTimeSeries = p_SystemCO2CreditsValueDollarsPerMWhTimeSeries;
            }
            
            [CustomFieldInput("CO2CreditsValueDollarsPerMWhTimeSeries", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public CL.FormulaHelper.DTOs.TimeSeriesDTO SystemCO2CreditsValueDollarsPerMWhTimeSeries  { get; private set; }
        }
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double p_CO2ReductionTV,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                CO2ReductionTV = p_CO2ReductionTV;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("CO2ReductionTV")]
            [DataMember]
            public System.Double CO2ReductionTV  { get; private set; }
