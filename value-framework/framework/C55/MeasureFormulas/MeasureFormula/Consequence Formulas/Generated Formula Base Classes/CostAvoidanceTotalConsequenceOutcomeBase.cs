...
{
    [FormulaBase]
    public abstract class CostAvoidanceTotalConsequenceOutcomeBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int64 p_CostsIncurredAfterThisInvestmentIsUndertaken,
                System.Double p_HoursIncurredIfThisInvestmentIsUndertaken,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                CostsIncurredAfterThisInvestmentIsUndertaken = p_CostsIncurredAfterThisInvestmentIsUndertaken;
                HoursIncurredIfThisInvestmentIsUndertaken = p_HoursIncurredIfThisInvestmentIsUndertaken;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("CostsIncurredAfterThisInvestmentIsUndertaken")]
            [DataMember]
            public System.Int64 CostsIncurredAfterThisInvestmentIsUndertaken  { get; private set; }
            
            [PromptInput("HoursIncurredIfThisInvestmentIsUndertaken")]
            [DataMember]
            public System.Double HoursIncurredIfThisInvestmentIsUndertaken  { get; private set; }
