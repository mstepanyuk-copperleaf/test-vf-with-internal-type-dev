...
{
    [FormulaBase]
    public abstract class EconDevFormulaBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_AnnualBenefit,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                AnnualBenefit = p_AnnualBenefit;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("AnnualBenefit")]
            [DataMember]
            public System.Int32 AnnualBenefit  { get; private set; }
