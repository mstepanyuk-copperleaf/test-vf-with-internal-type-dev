    ...
    public abstract class RiskConsequenceManualBase : FormulaConsequenceBase
    {
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                CL.FormulaHelper.DTOs.NumericValueRangeDTO p_ManualRiskConsequence,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                ManualRiskConsequence = p_ManualRiskConsequence;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("ManualRiskConsequence")]
            [DataMember]
            public CL.FormulaHelper.DTOs.NumericValueRangeDTO ManualRiskConsequence  { get; private set; }
