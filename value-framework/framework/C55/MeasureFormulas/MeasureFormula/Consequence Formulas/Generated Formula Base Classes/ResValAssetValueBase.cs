...
{
    [FormulaBase]
    public abstract class ResValAssetValueBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Int32 p_AssetBookAge,
                System.Double p_AssetValue,
                System.Double?[] p_ResidualValue_AssetEffectiveAge_ConsqUnitOutput)
            {
                AssetBookAge = p_AssetBookAge;
                AssetValue = p_AssetValue;
                ResidualValue_AssetEffectiveAge_ConsqUnitOutput = p_ResidualValue_AssetEffectiveAge_ConsqUnitOutput;
            }
            
            [PromptInput("AssetBookAge")]
            [DataMember]
            public System.Int32 AssetBookAge  { get; private set; }
            
            [PromptInput("AssetValue")]
            [DataMember]
            public System.Double AssetValue  { get; private set; }
            
            [MeasureInput("ResidualValue", "AssetEffectiveAge", MeasureOutputType.ConsqUnitOutput, false)]
            [DataMember]
            public System.Double?[] ResidualValue_AssetEffectiveAge_ConsqUnitOutput  { get; private set; }
        }
