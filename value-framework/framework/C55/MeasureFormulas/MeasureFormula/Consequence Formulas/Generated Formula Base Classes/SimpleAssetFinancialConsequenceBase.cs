...
{
    [FormulaBase]
    public abstract class SimpleAssetFinancialConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                CL.FormulaHelper.DTOs.NumericValueRangeDTO p_AssetFinancialRiskConsequence,
                CL.FormulaHelper.DTOs.NumericValueRangeDTO p_FailureSeverity)
            {
                AssetFinancialRiskConsequence = p_AssetFinancialRiskConsequence;
                FailureSeverity = p_FailureSeverity;
            }
            
            [CustomFieldInput("FinancialRiskConsequence", FormulaInputAssociatedEntity.Asset)]
            [DataMember]
            public CL.FormulaHelper.DTOs.NumericValueRangeDTO AssetFinancialRiskConsequence  { get; private set; }
