...
{
    [FormulaBase]
    public abstract class PMTotalMilesCostBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double?[] p_Mileage_TotalMileagePrivate_LikelihoodUnitOutput,
                System.Double? p_SystemPrivateMileageCostPoundsPerMile)
            {
                Mileage_TotalMileagePrivate_LikelihoodUnitOutput = p_Mileage_TotalMileagePrivate_LikelihoodUnitOutput;
                SystemPrivateMileageCostPoundsPerMile = p_SystemPrivateMileageCostPoundsPerMile;
            }
            
            [MeasureInput("Mileage", "TotalMileagePrivate", MeasureOutputType.LikelihoodUnitOutput, false)]
            [DataMember]
            public System.Double?[] Mileage_TotalMileagePrivate_LikelihoodUnitOutput  { get; private set; }
            
            [CustomFieldInput("PrivateMileageCostPoundsPerMile", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public System.Double? SystemPrivateMileageCostPoundsPerMile  { get; private set; }
        }
