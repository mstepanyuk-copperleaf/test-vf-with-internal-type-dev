...
{
    [FormulaBase]
    public abstract class AdditionalCostsTotalConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int64 p_AdditionalCosts,
                System.Double p_AdditionalHours,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                AdditionalCosts = p_AdditionalCosts;
                AdditionalHours = p_AdditionalHours;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("AdditionalCosts")]
            [DataMember]
            public System.Int64 AdditionalCosts  { get; private set; }
            
            [PromptInput("AdditionalHours")]
            [DataMember]
            public System.Double AdditionalHours  { get; private set; }
