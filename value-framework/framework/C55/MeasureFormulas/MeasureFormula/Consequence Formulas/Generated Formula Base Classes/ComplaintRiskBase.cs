...
{
    [FormulaBase]
    public abstract class ComplaintRiskBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
// TODO                System.Double?[] p_Complaints_ExpectedNumberOfComplaints_LikelihoodUnitOutput,
                System.Double? p_CostOfComplaint,
                System.Double? p_SystemCostOfComplaint
 )
            {
 //               Complaints_ExpectedNumberOfComplaints_LikelihoodUnitOutput = p_Complaints_ExpectedNumberOfComplaints_LikelihoodUnitOutput;
                CostOfComplaint = p_CostOfComplaint;
                SystemCostOfComplaint = p_SystemCostOfComplaint;
            }
   /*         
            [MeasureInput("AvoidedCustomerComplaints", "ExpectedNumberOfComplaints", MeasureOutputType.LikelihoodUnitOutput, false)]
            [DataMember]
            public System.Double?[] Complaints_ExpectedNumberOfComplaints_LikelihoodUnitOutput  { get; private set; }
 */           
            [PromptInput("CostOfComplaint")]
            [DataMember]
            public System.Double? CostOfComplaint  { get; private set; }
            
            [CustomFieldInput("CostOfComplaint", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public System.Double? SystemCostOfComplaint  { get; private set; }
