...
{
    [FormulaBase]
    public abstract class ResourceForecastEngineeringDesignBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            ...
            [CoreFieldInput(FormulaCoreFieldInputType.InvestmentSpendByResource)]
            [DataMember]
            public CL.FormulaHelper.DTOs.DistributionByResourceDTO InvestmentSpendByResource  { get; private set; }
        }
