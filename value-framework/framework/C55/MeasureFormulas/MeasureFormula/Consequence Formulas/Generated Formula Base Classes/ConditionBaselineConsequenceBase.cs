...
{
    [FormulaBase]
    public abstract class ConditionBaselineConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double? p_ConditionScore,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                ConditionScore = p_ConditionScore;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("ConditionScore")]
            [DataMember]
            public System.Double? ConditionScore  { get; private set; }
