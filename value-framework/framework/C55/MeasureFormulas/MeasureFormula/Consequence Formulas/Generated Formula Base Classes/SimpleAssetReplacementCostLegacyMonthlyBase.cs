...
{
    [FormulaBase]
    public abstract class SimpleAssetReplacementCostLegacyMonthlyBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                ...
                CL.FormulaHelper.DTOs.XYCurveDTO p_AssetTypeAnnualSpendProfileCurve,
                ...
                System.Double?[] p_ConditionScore_Condition_ConsqUnitOutput)
            {
                ...
                AssetTypeAnnualSpendProfileCurve = p_AssetTypeAnnualSpendProfileCurve;
            ...
            [CoreFieldInput(FormulaCoreFieldInputType.AssetTypeAnnualSpendProfileCurve)]
            [DataMember]
            public CL.FormulaHelper.DTOs.XYCurveDTO AssetTypeAnnualSpendProfileCurve  { get; private set; }
