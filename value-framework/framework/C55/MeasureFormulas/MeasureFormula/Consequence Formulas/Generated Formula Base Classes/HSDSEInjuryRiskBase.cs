...
{
    [FormulaBase]
    public abstract class HSDSEInjuryRiskBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
//                System.Double?[] p_HealthAndSafety_NumberOfDSEInjuries_LikelihoodUnitOutput,
                System.Double? p_SystemDSEInjuryCost)
            {
  //              HealthAndSafety_NumberOfDSEInjuries_LikelihoodUnitOutput = p_HealthAndSafety_NumberOfDSEInjuries_LikelihoodUnitOutput;
                SystemDSEInjuryCost = p_SystemDSEInjuryCost;
            }
            
  //          [MeasureInput("HealthAndSafetyQuestionnaire", "NumberOfDSEInjuries", MeasureOutputType.LikelihoodUnitOutput, false)]
  //          [DataMember]
  //          public System.Double?[] HealthAndSafety_NumberOfDSEInjuries_LikelihoodUnitOutput  { get; private set; }
            
            [CustomFieldInput("DSEInjuryCost", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public System.Double? SystemDSEInjuryCost  { get; private set; }
        }
