...
{
    [FormulaBase]
    public abstract class SimpleAssetLostEfficiencyOpportunityLegacyMonthlyBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                ...
                System.Double?[] p_ConditionScore_Condition_ConsqUnitOutput_B,
                CL.FormulaHelper.DTOs.StrategyAlternativeDTO p_StrategyAlternative)
            {
                AssetGenerationGroup = p_AssetGenerationGroup;
                AssetInServiceDate = p_AssetInServiceDate;
                ConditionScore_Condition_ConsqUnitOutput_B = p_ConditionScore_Condition_ConsqUnitOutput_B;
                StrategyAlternative = p_StrategyAlternative;
            }
            ...
            [MeasureInput("ConditionScore", "Condition", MeasureOutputType.ConsqUnitOutput, true)]
            [DataMember]
            public System.Double?[] ConditionScore_Condition_ConsqUnitOutput_B  { get; private set; }
            
            [CoreFieldInput(FormulaCoreFieldInputType.StrategyAlternative)]
            [DataMember]
            public CL.FormulaHelper.DTOs.StrategyAlternativeDTO StrategyAlternative  { get; private set; }
        }
