...
{
    [FormulaBase]
    public abstract class SimpleAssetSafetyConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                CL.FormulaHelper.DTOs.NumericValueRangeDTO p_AssetSafetyRiskConsequence,
                CL.FormulaHelper.DTOs.NumericValueRangeDTO p_FailureSeverity)
            {
                AssetSafetyRiskConsequence = p_AssetSafetyRiskConsequence;
                FailureSeverity = p_FailureSeverity;
            }
            
            [CustomFieldInput("SafetyRiskConsequence", FormulaInputAssociatedEntity.Asset)]
            [DataMember]
            public CL.FormulaHelper.DTOs.NumericValueRangeDTO AssetSafetyRiskConsequence  { get; private set; }
