...
namespace CustomerFormulaCode
{
	...
	/// </summary>
	[Formula]
	public class ResourceForecastEngineeringDesign : ResourceForecastEngineeringDesignBase
	{
		public override double?[] GetUnits(int startFiscalYear, int months,
		                                   TimeInvariantInputDTO timeInvariantData, IReadOnlyList<TimeVariantInputDTO> timeVariantData)
		{
			return ResourceSupply.GetSpendForResourceType(months, timeInvariantData.InvestmentSpendByResource, CoreConstants.ENG_DESIGN);
		}
