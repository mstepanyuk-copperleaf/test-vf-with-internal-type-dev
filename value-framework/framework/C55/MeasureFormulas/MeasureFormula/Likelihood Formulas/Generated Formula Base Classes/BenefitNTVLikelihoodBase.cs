...
{
    [FormulaBase]
    public abstract class BenefitNTVLikelihoodBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Int32 p_BenefitProbabilityNTV)
            {
            ...
            [DataMember]
            public System.Int32 BenefitProbabilityNTV  { get; private set; }
        }
