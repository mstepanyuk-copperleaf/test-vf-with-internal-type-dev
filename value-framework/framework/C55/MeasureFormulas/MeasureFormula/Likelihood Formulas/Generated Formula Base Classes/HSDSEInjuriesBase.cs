...
{
    [FormulaBase]
    public abstract class HSDSEInjuriesBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_NoOfInjuriesDSE,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                NoOfInjuriesDSE = p_NoOfInjuriesDSE;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("NoOfInjuriesDSE")]
            [DataMember]
            public System.Int32 NoOfInjuriesDSE  { get; private set; }
