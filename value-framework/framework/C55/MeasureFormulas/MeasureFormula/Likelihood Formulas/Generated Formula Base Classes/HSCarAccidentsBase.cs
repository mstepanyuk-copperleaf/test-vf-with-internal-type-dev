...
{
    [FormulaBase]
    public abstract class HSCarAccidentsBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_NoOfAccidents,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                NoOfAccidents = p_NoOfAccidents;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("NoOfAccidents")]
            [DataMember]
            public System.Int32 NoOfAccidents  { get; private set; }
