...
{
    [FormulaBase]
    public abstract class SimpleAssetFinancialProbabilityBaselineBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double? p_AssetTypeFinancialRiskExposureFactor,
                System.Double?[] p_ConditionScore_Condition_ConsqUnitOutput,
                CL.FormulaHelper.DTOs.XYCurveDTO p_ConditionToFailureCurve)
            {
                AssetTypeFinancialRiskExposureFactor = p_AssetTypeFinancialRiskExposureFactor;
            ...
            [CustomFieldInput("FinancialRiskExposureFactor", FormulaInputAssociatedEntity.AssetType)]
            [DataMember]
            public System.Double? AssetTypeFinancialRiskExposureFactor  { get; private set; }
