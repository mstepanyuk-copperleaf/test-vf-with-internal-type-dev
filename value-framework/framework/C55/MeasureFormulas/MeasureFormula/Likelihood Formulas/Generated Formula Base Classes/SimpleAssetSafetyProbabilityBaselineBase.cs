...
{
    [FormulaBase]
    public abstract class SimpleAssetSafetyProbabilityBaselineBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double? p_AssetTypeSafetyRiskExposureFactor,
                System.Double?[] p_ConditionScore_Condition_ConsqUnitOutput,
                CL.FormulaHelper.DTOs.XYCurveDTO p_ConditionToFailureCurve)
            {
                AssetTypeSafetyRiskExposureFactor = p_AssetTypeSafetyRiskExposureFactor;
            ...
            [CustomFieldInput("SafetyRiskExposureFactor", FormulaInputAssociatedEntity.AssetType)]
            [DataMember]
            public System.Double? AssetTypeSafetyRiskExposureFactor  { get; private set; }
