...
{
    [FormulaBase]
    public abstract class HSOtherInjuriesBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_NoOfInjuriesOther,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                NoOfInjuriesOther = p_NoOfInjuriesOther;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("NoOfInjuriesOther")]
            [DataMember]
            public System.Int32 NoOfInjuriesOther  { get; private set; }
