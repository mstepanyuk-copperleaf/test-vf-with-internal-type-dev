...
{
    [FormulaBase]
    public abstract class RiskLikelihoodManualBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                CL.FormulaHelper.DTOs.NumericValueRangeDTO p_ManualRiskProbability,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                ManualRiskProbability = p_ManualRiskProbability;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("ManualRiskProbability")]
            [DataMember]
            public CL.FormulaHelper.DTOs.NumericValueRangeDTO ManualRiskProbability  { get; private set; }
