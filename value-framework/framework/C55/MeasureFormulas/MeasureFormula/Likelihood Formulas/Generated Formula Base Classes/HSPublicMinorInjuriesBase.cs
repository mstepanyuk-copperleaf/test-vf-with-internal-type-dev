...
{
    [FormulaBase]
    public abstract class HSPublicMinorInjuriesBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                ...
                System.Double? p_ProbabilityOfMemberOfPublicMinorInjury)
            {
                NumberOfMembersOfPublicAffected = p_NumberOfMembersOfPublicAffected;
                ProbabilityOfMemberOfPublicMinorInjury = p_ProbabilityOfMemberOfPublicMinorInjury;
            }
            ...
            [PromptInput("ProbabilityOfMemberOfPublicMinorInjury")]
            [DataMember]
            public System.Double? ProbabilityOfMemberOfPublicMinorInjury  { get; private set; }
        }
