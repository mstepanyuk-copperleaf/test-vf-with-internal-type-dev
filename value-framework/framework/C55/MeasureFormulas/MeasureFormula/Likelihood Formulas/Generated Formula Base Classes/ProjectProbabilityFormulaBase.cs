...
{
    [FormulaBase]
    public abstract class ProjectProbabilityFormulaBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double p_BenefitProbabilityNTV)
            {
                BenefitProbabilityNTV = p_BenefitProbabilityNTV;
            }
            
            [PromptInput("BenefitProbabilityNTV")]
            [DataMember]
            public System.Double BenefitProbabilityNTV  { get; private set; }
        }
