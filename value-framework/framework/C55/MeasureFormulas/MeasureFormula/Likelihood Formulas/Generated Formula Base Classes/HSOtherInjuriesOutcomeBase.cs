...
{
    [FormulaBase]
    public abstract class HSOtherInjuriesOutcomeBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
// TODO                System.Double?[] p_HealthAndSafety_NumberOfOtherInjuries_LikelihoodUnitOutput_B,
                CL.FormulaHelper.DTOs.DistributionByAccountTypeDTO p_InvestmentSpendByAccountType,
                System.Int32 p_PercentReduction)
            {
//                HealthAndSafety_NumberOfOtherInjuries_LikelihoodUnitOutput_B = p_HealthAndSafety_NumberOfOtherInjuries_LikelihoodUnitOutput_B;
                InvestmentSpendByAccountType = p_InvestmentSpendByAccountType;
                PercentReduction = p_PercentReduction;
            }
            
//            [MeasureInput("HealthAndSafetyQuestionnaire", "NumberOfOtherInjuries", MeasureOutputType.LikelihoodUnitOutput, true)]
//            [DataMember]
//            public System.Double?[] HealthAndSafety_NumberOfOtherInjuries_LikelihoodUnitOutput_B  { get; private set; }
            ...
            [PromptInput("PercentReduction")]
            [DataMember]
            public System.Int32 PercentReduction  { get; private set; }
        }
