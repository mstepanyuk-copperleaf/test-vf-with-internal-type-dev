...
{
    [FormulaBase]
    public abstract class CMTotalMilesBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Int32 p_AverageMileage)
            {
                AverageMileage = p_AverageMileage;
            }
            
            [PromptInput("AverageMileage")]
            [DataMember]
            public System.Int32 AverageMileage  { get; private set; }
        }
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_NoOfVehicles,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                NoOfVehicles = p_NoOfVehicles;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("NoOfVehicles")]
            [DataMember]
            public System.Int32 NoOfVehicles  { get; private set; }
