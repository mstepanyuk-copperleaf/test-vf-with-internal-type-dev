...
{
    [FormulaBase]
    public abstract class POPBenefitLikelihoodBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_PopBenefitProbability,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                PopBenefitProbability = p_PopBenefitProbability;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("PopBenefitProbability")]
            [DataMember]
            public System.Int32 PopBenefitProbability  { get; private set; }
