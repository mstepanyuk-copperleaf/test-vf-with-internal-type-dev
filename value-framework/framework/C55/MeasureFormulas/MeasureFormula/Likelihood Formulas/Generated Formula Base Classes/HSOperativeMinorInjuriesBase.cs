...
{
    [FormulaBase]
    public abstract class HSOperativeMinorInjuriesBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                ...
                System.Double? p_ProbabilityOfOperativeMinorInjury)
            {
                NumberOfOperativesAffected = p_NumberOfOperativesAffected;
                ProbabilityOfOperativeMinorInjury = p_ProbabilityOfOperativeMinorInjury;
            }
            ...
            [PromptInput("ProbabilityOfOperativeMinorInjury")]
            [DataMember]
            public System.Double? ProbabilityOfOperativeMinorInjury  { get; private set; }
        }
