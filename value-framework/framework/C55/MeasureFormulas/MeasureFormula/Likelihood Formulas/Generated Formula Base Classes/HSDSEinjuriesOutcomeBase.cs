...
{
    [FormulaBase]
    public abstract class HSDSEinjuriesOutcomeBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
     //  TODO          System.Double?[] p_HealthAndSafety_NumberOfDSEInjuries_LikelihoodUnitOutput_B,
                CL.FormulaHelper.DTOs.DistributionByAccountTypeDTO p_InvestmentSpendByAccountType,
                System.Int32 p_PercentReduction)
            {
   //             HealthAndSafety_NumberOfDSEInjuries_LikelihoodUnitOutput_B = p_HealthAndSafety_NumberOfDSEInjuries_LikelihoodUnitOutput_B;
                InvestmentSpendByAccountType = p_InvestmentSpendByAccountType;
                PercentReduction = p_PercentReduction;
            }
            
 //           [MeasureInput("HealthAndSafetyQuestionnaire", "NumberOfDSEInjuries", MeasureOutputType.LikelihoodUnitOutput, true)]
 //           [DataMember]
 //           public System.Double?[] HealthAndSafety_NumberOfDSEInjuries_LikelihoodUnitOutput_B  { get; private set; }
