...
{
    [FormulaBase]
    public abstract class SimpleAssetProbabilityPDFBaselineBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                ...
                System.Int32? p_SystemNumBaselinePdfSubsamples)
            {
                ...
                SystemNumBaselinePdfSubsamples = p_SystemNumBaselinePdfSubsamples;
            }
            ...
            [CustomFieldInput("NumBaselinePdfSubsamples", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public System.Int32? SystemNumBaselinePdfSubsamples  { get; private set; }
        }
