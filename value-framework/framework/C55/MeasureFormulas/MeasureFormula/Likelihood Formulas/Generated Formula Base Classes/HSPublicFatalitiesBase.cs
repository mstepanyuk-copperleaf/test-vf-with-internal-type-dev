...
{
    [FormulaBase]
    public abstract class HSPublicFatalitiesBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                ...
                System.Double? p_ProbabilityOfMemberOfPublicFatality)
            {
                NumberOfMembersOfPublicAffected = p_NumberOfMembersOfPublicAffected;
                ProbabilityOfMemberOfPublicFatality = p_ProbabilityOfMemberOfPublicFatality;
            }
            ...
            [PromptInput("ProbabilityOfMemberOfPublicFatality")]
            [DataMember]
            public System.Double? ProbabilityOfMemberOfPublicFatality  { get; private set; }
        }
