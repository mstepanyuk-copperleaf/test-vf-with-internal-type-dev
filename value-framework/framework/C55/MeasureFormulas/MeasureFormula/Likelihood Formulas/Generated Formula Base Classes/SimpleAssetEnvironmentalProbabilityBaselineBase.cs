...
{
    [FormulaBase]
    public abstract class SimpleAssetEnvironmentalProbabilityBaselineBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double? p_AssetTypeEnvironmentalRiskExposureFactor,
                System.Double?[] p_ConditionScore_Condition_ConsqUnitOutput,
                CL.FormulaHelper.DTOs.XYCurveDTO p_ConditionToFailureCurve)
            {
                AssetTypeEnvironmentalRiskExposureFactor = p_AssetTypeEnvironmentalRiskExposureFactor;
            ...
            [CustomFieldInput("EnvironmentalRiskExposureFactor", FormulaInputAssociatedEntity.AssetType)]
            [DataMember]
            public System.Double? AssetTypeEnvironmentalRiskExposureFactor  { get; private set; }
