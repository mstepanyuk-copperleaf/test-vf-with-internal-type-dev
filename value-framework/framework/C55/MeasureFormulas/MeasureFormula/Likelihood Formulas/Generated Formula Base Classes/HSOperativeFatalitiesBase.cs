...
{
    [FormulaBase]
    public abstract class HSOperativeFatalitiesBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                ...
                System.Double? p_ProbabilityOfOperativeFatality)
            {
                NumberOfOperativesAffected = p_NumberOfOperativesAffected;
                ProbabilityOfOperativeFatality = p_ProbabilityOfOperativeFatality;
            }
            ...
            [PromptInput("ProbabilityOfOperativeFatality")]
            [DataMember]
            public System.Double? ProbabilityOfOperativeFatality  { get; private set; }
        }
