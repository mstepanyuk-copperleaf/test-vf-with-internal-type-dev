...
{
    [FormulaBase]
    public abstract class RiskLikelihoodManualBaselineBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                CL.FormulaHelper.DTOs.NumericValueRangeDTO p_ProbPenFine,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                ProbPenFine = p_ProbPenFine;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("ProbPenFine")]
            [DataMember]
            public CL.FormulaHelper.DTOs.NumericValueRangeDTO ProbPenFine  { get; private set; }
