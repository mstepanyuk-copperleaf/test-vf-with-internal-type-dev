...
{
    [FormulaBase]
    public abstract class ComplaintsNumberBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_NoOfComplaints,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                NoOfComplaints = p_NoOfComplaints;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("NoOfComplaints")]
            [DataMember]
            public System.Int32 NoOfComplaints  { get; private set; }
