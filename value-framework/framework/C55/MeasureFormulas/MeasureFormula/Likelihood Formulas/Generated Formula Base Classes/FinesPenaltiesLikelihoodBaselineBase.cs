...
{
    [FormulaBase]
    public abstract class FinesPenaltiesLikelihoodBaselineBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                CL.FormulaHelper.DTOs.NumericValueRangeDTO p_FineLikelihood,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                FineLikelihood = p_FineLikelihood;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("FineLikelihood")]
            [DataMember]
            public CL.FormulaHelper.DTOs.NumericValueRangeDTO FineLikelihood  { get; private set; }
